...
All menus, prompts, and orchestration live in operators/cli.py. Dataset
preprocessing is handled by utils/erp_dataset.py, forward operator
training/evaluation by operators/neural_operator_utils.py, inverse-model
...
from operators.cli import main
